                ...
                <div style={{display: "flex", justifyContent: "flex-start", width: "100%"}}>
                    ...
                    <div className={styles.leftSideProfile}>
                        ...
                        <div className={styles.buttonsContainer}>
                            ...
                            <button className={styles.profileButtonTwo}>Book a Meeting</button>
                        </div>
                    </div>
                    ...
                    <div className={styles.rightSideProfile}>
                        <div style={{textAlign:"left",  fontWeight:"bold",fontSize:12, display:"flex",flexDirection:"column",gap: 14}}>
                            <p>Calls per day:</p>
                            <p>Age:</p>
                            <p>Languages:</p>
                        ...
                        <div style={{textAlign:"left", display:"flex",fontSize:12,flexDirection:"column",gap: 14}}>
                            <p>12</p>
                            <p>23</p>
