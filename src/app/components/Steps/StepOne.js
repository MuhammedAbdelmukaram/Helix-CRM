...
const StepOne = ({
    ...
    const formattedNicheOptions = nicheOptions.map(niche => ({ value: niche, label: niche }));
    ...
    const formattedLanguageOptions = languageOptions.map(lang => ({ value: lang, label: lang }));
    ...
    return (
        <div>
            ...
            <div className={styles.inputGroup}>
                ...
                >
                    ...
                    {countries.map(({ isoCode, name }) => (
                        <option key={name} value={isoCode}>{name}</option>
                    ))}
                </select>
            </div>
            <div className={styles.inputGroup}>
                ...
                >
                    ...
                    {cities.map((city, index) => (
                        ...
                        <option key={`${city.name}-${city.countryCode}-${city.stateCode}-${city.latitude}-${city.longitude}`} value={city.name}>{city.name}</option>
                    ))}
                </select>
            ...
            <div className={styles.inputGroup}>
                <label htmlFor="experience">How many years of sales experience you have</label>
                <select
                    id="experience"
                    name="experience"
                    value={experience}
            ...
            {isOtherNiche && (
                <input
                    ...
                    style={{backgroundColor:"transparent", border:"1px solid #606060", width:"100%", padding:"10px 10px"}}
                />
            )}
