...
const StepZero = ({ handleChange, phoneNumber, setPhoneNumber, onPasswordMatch }) => {
    ...
    const validatePassword = (password) => {
        ...
        if (regex.test(password)) {
            ...
            setPasswordValidationMessage('Password must be at least 8 characters long, include a number, a special character, and a capital letter.');
        }
    };
    ...
    return (
        <div>
            <div className={styles.inputGroup}>
                ...
                <input id="name" name="name" type="text" required onChange={handleChange} placeholder="Your Name" />
            </div>
            <div className={styles.inputGroup}>
                <label htmlFor="email">Email</label>
                <input id="email" name="email" type="email" required onChange={handleChange} placeholder="Your Email" />
            </div>
            <div className={styles.inputGroup}>
